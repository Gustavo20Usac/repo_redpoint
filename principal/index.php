...
<body onload="firsttime()">
    <div id="page"><div id="page2">
            ...
            <iframe src="map.html" name="loader" id="loader" width="920" height="495" frameborder="0"></iframe>        
            </div></div> 
            <div id="main"><div id="main2">&nbsp;<div id="main3"><center>
            <ul class="tt-wrapper">
				<li style="list-style:none;"><a class="tt-gplus" href="map.html" target="loader"><span>Inicio</span></a></li>
